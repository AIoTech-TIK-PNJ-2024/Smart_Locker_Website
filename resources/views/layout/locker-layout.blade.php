        ...
        <section class="lg:flex lg:h-full items-center justify-center w-full">
            ...
            <div class="lg:w-1/2 p-8">
                ...
                <form>
                    ...
                    <button type="submit"
                        class="w-full bg-green-head text-white py-2 my-6 rounded-full font-medium focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-opacity-50">Masuk</button>
                </form>
            </div>
        </section>
    </body>
